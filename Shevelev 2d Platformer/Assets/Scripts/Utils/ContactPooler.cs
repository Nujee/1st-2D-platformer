...
namespace PlatformerMVC
{
    public class ContactPooler
    {
        ...
        private const float _collThreshhold = 0.6f;
        ...
        public void Update()
        {
            ...
            {
                if (_contacts[i].normal.y > _collThreshhold) IsGrounded = true;
                if (_contacts[i].normal.x > _collThreshhold) HasLeftContact = true;
                if (_contacts[i].normal.x > -_collThreshhold) HasRightContact = true;
            }
        }
    }
}